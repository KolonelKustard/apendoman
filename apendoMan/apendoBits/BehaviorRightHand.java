 ...
 * @version 
 */
public class BehaviorRightHand extends Behavior {
    private final int SCREEN_WIDTH = 640;
    private final int SCREEN_HEIGHT = 480;
    private final float Y_MIN_LIMIT = -0.8f;
    private final float Y_MAX_LIMIT = 1.3f;
    ...
    public BehaviorRightHand(TransformGroup lupperarmTG, TransformGroup llowerarmTG, TransformGroup vpTG, TransformGroup dummyTG) {
    ...
    private void sortInput(Enumeration criteria) {
